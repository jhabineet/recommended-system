...
# import requests
# # "https://api.themoviedb.org/3/movie/{}?api_key=f339b5f8de25dea78f84fb2331edcff6".format(movie_id)
...
def fetch_poster(movie_id):
    url = "https://api.themoviedb.org/3/movie/{}?api_key=f339b5f8de25dea78f84fb2331edcff6".format(movie_id)
    data = requests.get(url)
    data = data.json()
    poster_path = data['poster_path']
